...
PARITY = {
    ...
    "select": "retest", "отбор": "retest",  # отборочный тест Писателя (этап 8) = пакет пере-теста
}
...
PANEL_TO_CLI = {
    ...
    "lint-manual": "lint", "manual-canonist": "canonize", "onboarding-manual-answer": "onboarding",
}
