"""Расширенная проверка П-1 (имена документов, маркеры тайн и номера решений эталона в движке, панели, бандле;
серийные маркеры — только в профиле). П-1 / FR-SC-11 (статический тест): в движке нет констант серии. Имена персонажей, названия серий, имена
