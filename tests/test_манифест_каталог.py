...
def test_правила_ячейки_знания_из_yaml():
    ...
    assert declparse._knowledge_cell("ch. 7 / letter", rules, False) == (7, "")
    assert declparse._knowledge_cell("пусто", rules, False) == (None, "")
    assert declparse._knowledge_cell("с начала", rules, False) == (0, "")
    assert declparse.knowledge_rules(rules)["partial"] == "_"
