"""Отмена долгой задачи автором (аудит 2, находка 5.5): один флаг на процесс.

Проверяется между вызовами моделей (`konveyer run`, `konveyer circles`, авто-повторы Э1): прерывать
