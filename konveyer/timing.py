"""Время такта из истории FSM: машинное против авторского (критерий приёмки 1; аудит 2, находка 5.7).
...
* интервал между двумя переходами, записанными ВНУТРИ ОДНОЙ задачи (`konveyer такт`, кнопка панели,
