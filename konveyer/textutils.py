...
TTR по словоформам (Д-14), речь повествователя без реплик, документы-вставки (Д-15). Правила языка живут
в `языки/<код>.yaml`; здесь — совместимый интерфейс для проверок и линтера (русский по умолчанию)."""
