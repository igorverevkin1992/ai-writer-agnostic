...
Форматы описаны в `Библиотека/ИНСТРУМЕНТ_Соглашения_разметки.md`.
При расхождении структуры парсер обязан указать файл и строку (§6.4).
"""
...
class MarkupError(ValueError):
    """Расхождение структуры MD с соглашениями Д-1 (§6.4)."""
