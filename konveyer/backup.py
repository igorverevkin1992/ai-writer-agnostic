"""Сохранность (§7.15): раскладка библиотеки относительно git, архив рабочей
...
ARCHIVE_ITEMS = ("главы", "журналы", "драматургия", "снапшоты", "рукопись", "регрессия", "онбординг", "конфиг.yaml", "проект.yaml")
