...
export function Circles(props: {
  ...
  return (
    <>
      ...
      <p className="muted">
        Круг истории — несущий каркас драматургии и темпа: круг тома → круги {nActs} актов →
        круги глав; каждый уровень строится внутри шага уровня выше. Черновики лежат в <code>драматургия/</code>;
        после внесения в канон (документ каркасов) они попадают в окно Писателя («Драматургия главы») и в проверку Э2 (4.4).
